...
class MyComplaintsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MindleTopAppBar(title: '내가 작성한 민원'),
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  SvgPicture.asset(
                    'assets/icons/filled/Document.svg',
                    width: 80,
                    height: 80,
                  ),
                  SizedBox(height: 4),
                  Text("내가 작성한 민원", style: MindleTextStyles.subtitle2()),
                  SizedBox(height: 4),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      ...
                      Text("의 글을 작성했어요!", style: MindleTextStyles.body4()),
                    ],
                  ),
                ],
              ),
